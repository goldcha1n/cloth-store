...
class UserRegistrationViewTestCase(TestCase):
    def setUp(self):
        self.data = {
            'first_name': 'User', 'last_name': 'UserLastName',
            'username': 'goldcha1n', 'email': 'testuser@madl.cpm',
    ...
    def test_user_registration_post_success(self):
        ...
        email_verification = UserEmailVerification.objects.filter(user__username=username)
